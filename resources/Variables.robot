...
### Buy vignette page
${BUY_VIGNETTE_LIGHT_VEHICLE_BUTTON} =  xpath=//div[@class='img-fluid car mb-4']
${BUY_VUGNETTE_HGV_BUTTON} =  xpath=//div[@class='img-fluid hgv mb-4']
${BUY_VIGNETTE_CARAVAN_TRAILER_BUTTON} =  xpath=//div[@class='img-fluid trailer mb-4']
